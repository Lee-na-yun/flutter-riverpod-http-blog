...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    //final ap = ref.read(authProvider); // isLogin이 true인지 아닌지 확인
    final hvm = ref.watch(homePageViewModel.notifier); //state관리하려면 notifier로 읽어야 함 ==> 홈페이지가 열릴때 homePageViewModel이 열림
